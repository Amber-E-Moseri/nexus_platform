...
import { setupSlackIntegration } from '../../lib/user-integrations/api'
  ...
  useEffect(() => {
    async function handleCallback() {
      try {
        ...
        await setupSlackIntegration(profile.id, slackData)
      ...
      <div className="rounded-2xl border border-[var(--border)] bg-white p-8 shadow-lg">
        {status === 'processing' && (
          <div className="space-y-4 text-center">
            ...
            <h1 className="text-xl font-semibold text-[var(--text-primary)]">Connecting Slack</h1>
        ...
        {status === 'success' && (
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[var(--text-secondary)]">Slack is now connected. Redirecting...</p>
          </div>
        )}
