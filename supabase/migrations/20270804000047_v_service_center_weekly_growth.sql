-- Growth Tracking — weekly aggregation view
-- One row per (active center × ISO week).
-- status: merged/did_not_meet come from admin flags; reported = has data; missing = past week no data; current = this week in progress.
