-- Fix open_task_count in dashboard RPCs to count the calling user's own
-- open tasks (assignee_id = p_user_id) rather than all org tasks.
-- "Delegated" tasks (assigned to someone else) are excluded by this scope.

-- ── get_dashboard_data (primary RPC) ─────────────────────────────────────────
...
-- ── get_dashboard_stats (legacy fallback) ────────────────────────────────────
